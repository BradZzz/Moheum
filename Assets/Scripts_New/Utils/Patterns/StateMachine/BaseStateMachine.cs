...
namespace Patterns.StateMachine
{
    public abstract class BaseStateMachine
    {
        ...
        public void RegisterState(IState state)
        {
            ...
            Logger.Log<BaseStateMachine>(Handler.Name + ", Registered: ", "black", type);
        }
        ...
        public void Initialize()
        {
            ...
            Logger.Log<BaseStateMachine>(Handler.Name + ", Initialized! ", "yellow");
        }
        ...
        public void PushState(IState state, bool isSilent = false)
        {
            ...
            Logger.Log<BaseStateMachine>(Handler.Name + ", Push state: ", "green", type);
        ...
        public void PopState(bool isSilent = false)
        {
            ...
            var state = stack.Pop();
            Logger.Log<BaseStateMachine>(Handler.Name + ", Pop state: ", "purple", state.GetType());
            state.OnExitState();
